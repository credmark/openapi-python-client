...
def sync(param_path: str, *, param_query: Union[Unset, None, str] = UNSET, client: "MyTestApiClient") -> Any:
    """
    Args:
        param_path (str):
        param_query (Union[Unset, None, str]):
...
async def asyncio(param_path: str, *, param_query: Union[Unset, None, str] = UNSET, client: "MyTestApiClient") -> Any:
    """
    Args:
        param_path (str):
        param_query (Union[Unset, None, str]):
