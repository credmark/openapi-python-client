...
def sync_detailed(*, form_data: PostFormDataInlineData, client: Union[MyTestApiClient, Unset] = UNSET) -> Response[Any]:
...
async def asyncio_detailed(
    *, form_data: PostFormDataInlineData, client: Union[MyTestApiClient, Unset] = UNSET
) -> Response[Any]:
    """Post form data (inline schema)
